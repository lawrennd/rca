...
% end
%}
Y = Y{2};   % 1 for walking, 2 for dancing
Cy = Y'*Y / size(Y,1);
...
figure(3), hold on, plot(Recalls+jit, Precisions+jit, '-og'), xlim([0 1]), ylim([0 1]), xlabel('Recall'), ylabel('Precision'), legend('inv.cov','Glasso','EM-RCA')
