function skelPlayData(skelStruct, channels, frameLength, useConnections)
...
handle = skelVisualise(channels(1, :), skelStruct, 0, useConnections);  %  FIX !!!
...
for j = 1:size(channels, 1)
  pause(frameLength)
  skelModify(handle, channels(j, :), skelStruct, 0, useConnections);    %  FIX !!!
end
