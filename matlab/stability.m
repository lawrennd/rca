...
clc, clear
s = RandStream('mcg16807','Seed', 1e+4); RandStream.setDefaultStream(s) % laplace 1e+6
nRestarts = 100;
...
for iRestart = 1:nRestarts
    ...
    demProtSigEMRca1                            % Insert demo script here for which you want to stabilise results.
